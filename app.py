...
DEFAULT_CONFIG = {
    "site_title": "𝙳𝚁𝙸𝙵𝚃 PREMIUM VPS",
    "site_header": "𝙳𝚁𝙸𝙵𝚃 VPS",
    ...
    "passwords": {
        "secret": hashlib.sha256("𝙳𝚁𝙸𝙵𝚃XADMIN24".encode()).hexdigest(),
...
async def api_check(message: types.Message):
    ...
    try:
        ...
        r = requests.get(url, timeout=15, headers={
            'User-Agent': 'Mozilla/5.0 (𝙳𝚁𝙸𝙵𝚃 VPS Bot)'
        })
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("𝙳𝚁𝙸𝙵𝚃 PREMIUM VPS - Starting...")
    print("=" * 50)
    print(f"Port: {port}")
    print(f"Debug: {debug}")
    ...
    print("  Secret: 𝙳𝚁𝙸𝙵𝚃XADMIN24 (Can change user password)")
